        ...
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                ...
                <tr>
                    ...
                    <td class=cp valign=top width=7 height=12>
                        <img height=12 src="/res/boletophp/imagens//1.png" width=1 border=0>
                    </td><td class=cp valign=top width=126 height=12>
                        <span class="campo">
        ...
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=7 height=1><img height=1 src="/res/boletophp/imagens//2.png" width=7 border=0>
                    </td>
                    <td valign=top width=180 height=1>
                        <img height=1 src="/res/boletophp/imagens//2.png" width=180 border=0>
                    </td>
        ...
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                <tr>
                    ...
                    <td class=ct valign=top width=153 height=13>Nº do documento</td>
                    <td class=ct valign=top width=7 height=13>
                        <img height=13 src="/res/boletophp/imagens//1.png" width=1 border=0>
                    </td>
                    ...
                    <td class=ct valign=top width=82 height=13>Data de processamento</td>
                    <td class=ct valign=top width=7 height=13>
                        <img height=13 src="/res/boletophp/imagens//1.png" width=1 border=0>
                    </td>
                ...
                <tr>
                    ...
                    <td valign=top width=153 height=1><img height=1 src="/res/boletophp/imagens//2.png" width=153 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="/res/boletophp/imagens//2.png" width=7 border=0>
                    </td>
                        ...
                        <table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                                <tr>
                                    ...
                                    <td class=ct valign=top width=180 height=13>(-) Desconto / Abatimentos
                                    </td>
                                </tr>
                                <tr>
                                    <td class=cp valign=top width=7 height=12>
